// Code generated by "enumer -type formatter -linecomment -text -output formatter_string.go"; DO NOT EDIT.
...
// MarshalText implements the encoding.TextMarshaler interface for formatter
func (i formatter) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for formatter
func (i *formatter) UnmarshalText(text []byte) error {
	var err error
	*i, err = formatterString(string(text))
	return err
}
